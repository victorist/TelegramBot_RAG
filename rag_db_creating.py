...
# M2
#device = metall.Device("m2")
#metall_embeddings = metall.Embedding(device, model_path=model_path)

# gemoni recomendation >>> 
# docsearch = LanceDB.from_documents(filtered_fragments, embeddings, reranker=reranker)
# gemini 2
text_fragments = [fragment.page_content for fragment in filtered_fragments]
docsearch = LanceDB.from_documents(text_fragments, embeddings, reranker=reranker)


# M2
#docsearch = LanceDB.from_documents(filtered_fragments.page_content, metall_embeddings, reranker=reranker)
